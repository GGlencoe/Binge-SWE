      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="flex justify-end items-center pt-4">
          <button
            ...
            className="flex items-center gap-1.5 px-4 py-2 rounded-xl bg-white text-gray-600 text-sm font-medium shadow-sm hover:bg-red-50 hover:text-red-500 transition border border-gray-100"
          >
        ...
        <div className="text-center mb-6 pt-4">
          ...
          <div className="flex justify-center mb-2">
            <AiRecommendation type={subTab} source={section} />
          </div>
        </div>
